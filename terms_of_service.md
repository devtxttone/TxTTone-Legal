...
### 2.2 Data Backup
While we may offer optional cloud backup features, you are solely responsible for backing up your data. We are not responsible for any loss of data.
...
- By using audio files with the App, you represent that you have the necessary rights and licenses
- You are solely responsible for ensuring your audio files do not infringe on third-party copyrights or trademarks
...
The App offers in-app purchases for premium features, including:
- Ad-free version
...
- Payments are non-refundable except as required by law or as stated in Google Play's refund policy
- You are responsible for any applicable taxes

### 4.3 Subscription Terms (if applicable)
- Subscriptions automatically renew unless canceled at least 24 hours before the end of the current period
- You can manage or cancel subscriptions through your Google Play account settings
- No refunds will be provided for unused portions of a subscription
...
### 5.1 Free Version
The free version of the App displays advertisements provided by third-party advertising networks (e.g., Google AdMob).

### 5.2 Ad-Free Option
You may purchase the premium version to remove all advertisements.
...
- Damages resulting from errors, mistakes, or inaccuracies in the App
...
- Your use of audio files that infringe on third-party intellectual property rights
...
- Update or change features, functionality, or pricing
...
- Provisions that by their nature should survive (e.g., disclaimers, limitations of liability) will remain in effect

---

## 10. Third-Party Links and Services

The App may contain links to third-party websites, services, or content not owned or controlled by us. We are not responsible for:
